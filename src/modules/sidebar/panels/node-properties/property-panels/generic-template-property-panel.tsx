...
export default function GenericTemplatePropertyPanel({ id }: { id: string }) {
  ...
  // At the top of your component (after the guard)
    ...
    <div className="flex flex-col gap-4.5 p-4 bg-dark-400 dark:bg-dark-900 text-light-100 dark:text-light-100">
      ...
      <div className="flex flex-col relative">
        ...
        <textarea
          ...
          className="mt-2 w-full h-20 rounded bg-dark-900 text-light-100 p-2 text-sm border border-dark-500 outline-none focus:ring-2 focus:ring-teal-500 overflow-y-auto scrollbar-dark-teal"
        />
