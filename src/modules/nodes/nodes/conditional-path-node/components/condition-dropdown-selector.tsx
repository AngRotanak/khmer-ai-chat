...
const conditionList = [
  ...
  { id: 'added_to_cart', condition: 'អ្នកប្រើបានបន្ថែមទៅក្នុងកន្ត្រក' },
  { id: 'viewed_product', condition: 'អ្នកប្រើបានមើលផលិតផល' },
  { id: 'clicked_button', condition: 'អ្នកប្រើបានចុចប៊ូតុង' },
  { id: 'submitted-form', condition: 'អ្នកប្រើបានបញ្ចូនទម្រង់' },
  { id: 'messaged_page', condition: 'អ្នកប្រើបានផ្ញើសារមកទំព័រ' },
  { id: 'visited_page', condition: 'អ្នកប្រើបានចូលទំព័រមួយ' },
  { id: 'replied_to_bot', condition: 'អ្នកប្រើបានឆ្លើយតបនឹងបូត' },
  { id: 'clicked_carousel', condition: 'អ្នកប្រើបានចុចលើកាត' },
]
