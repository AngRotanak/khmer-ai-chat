  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          type="button"
          className="h-7 flex items-center justify-center border border-transparent rounded-lg bg-transparent px-1.5 outline-none transition active:(border-dark-200 bg-dark-400/50) data-[state=open]:(border-dark-200 bg-dark-500) data-[state=closed]:(hover:bg-dark-100)"
        >
            ...
            >
              <div className="flex flex-col gap-y-0.5">
                ...
                <div
                  className={cn(
                    'text-[11px] italic',
                    k === 'messenger' ? 'text-teal-400' : 'text-blue-400'
                  )}
                >
                  {v.description}
                </div>
