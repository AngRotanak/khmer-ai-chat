...
//// new structure method apply


//const { templates, paths } = buildMessengerExport(feature_blocks_by_type.info.info_skin_care);
...
// const { templates, paths } = exportFeatureBlockMessenger(feature_blocks_by_type.info.mEQAAQKq0Ecrc-xqmFjJW);
