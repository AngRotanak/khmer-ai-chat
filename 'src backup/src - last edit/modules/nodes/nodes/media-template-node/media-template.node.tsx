  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col p-4">
        <div className="text-xs text-light-900/50 font-medium">Condition</div>
...
export const metadata: RegisterNodeMetadata<MediaTemplateNodeData> = {
  ...
  defaultData: {
    ...
    is_active: true,
    media_type: 'image',
    media_url: 'https://storage.googleapis.com/khmer_aichatbot/clients/572772349252949/photo/Home.jpg',
    intro_text: {
    ...
    condition: {
      id: 'viewed_media',
      condition: 'អ្នកប្រើបានមើលមាតិកានេះ',
    },
  },
