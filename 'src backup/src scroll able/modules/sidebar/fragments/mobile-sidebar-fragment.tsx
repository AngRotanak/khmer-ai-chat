  ...
  return (
    <>
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 flex touch-none items-center justify-center p-4">
        <div className="pointer-events-auto flex touch-auto items-center gap-x-0.5 border border-dark-300 dark:border-dark-600 rounded-full bg-dark-900/80 dark:bg-dark-950/80 p-1 shadow-black/20 shadow-xl backdrop-blur-2xl">
          <button
          ...
          <button
            ...
            type="button"
            className="size-10 flex items-center justify-center rounded-full bg-transparent text-white dark:text-teal-300 transition active:(border-dark-300 bg-dark-600)"
          >
          ...
          <button
            ...
            className="size-10 flex items-center justify-center rounded-full bg-transparent text-white dark:text-teal-300 transition data-[is-validating=true]:(pointer-events-none cursor-not-allowed opacity-50) active:(border-dark-300 bg-dark-600)"
          >
          ...
          <a
            ...
            className="size-10 flex items-center justify-center rounded-full bg-transparent text-white dark:text-teal-300 transition active:(border-dark-300 bg-dark-600)"
          >
            <div className="i-mynaui:brand-telegram size-5" />
          </a>
          ...
          <a
            ...
            className="size-10 flex items-center justify-center rounded-full bg-transparent text-white dark:text-teal-300 transition active:(border-dark-300 bg-dark-600)"
          >
            <div className="i-mynaui:brand-facebook size-5" />
          </a>
        </div>
      </div>
