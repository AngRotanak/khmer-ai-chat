...
interface State {
  ...
  sidebar: {
    active: 'node-properties' | 'available-nodes' | 'khmer-ai-features' | 'unified-block-manager'| 'none';
    panels: {
      nodeProperties: {
...
interface Actions {
  actions: {
    ...
    sidebar: {
      setActivePanel: (panel: 'node-properties' | 'available-nodes' | 'khmer-ai-features' | 'unified-block-manager' | 'none') => void;
