...
export const IntentManagerPanel = () => {
    const { currentPageId } = useFlowSession()   // 👈 correct source
                ...
                <div className="mt-4 space-y-3 border border-dark-600 bg-dark-800 p-4 rounded-md">
                    ...
                    <div className="mt-6 border-t border-dark-600 pt-4">
                        ...
                        {newSubIntents.map((sub, idx) => (
                            <div key={idx} className="mb-4 p-3 border border-dark-600 rounded-md bg-dark-700">
                                <select
                                    value={sub.payload || ""}
                                    onChange={e => {
                                        const updated = [...newSubIntents]
                                ...
                                {/* Sub‑Intent Examples */}
                                <label className="text-xs text-light-200">English Examples</label>
                                {sub.examples.en.map((ex, i) => (
                                    <input
                                        ...
                                        className="w-full p-2 rounded bg-dark-800 text-light-100 text-sm mb-1"
                                    />
                                ))}
                                <button
                                ...
                                <label className="text-xs text-light-200 mt-2">Khmer Examples</label>
                                ...
                                {/* Sub‑Intent Responses */}
                                <label className="text-xs text-light-200 mt-2">Responses</label>
