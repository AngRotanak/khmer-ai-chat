...
import { ConditionPreviewPanel } from './components/ConditionPreviewPanel'
import { UserContextSimulator } from './components/UserContextSimulator'
    ...
    >
      ...
      <div className="flex flex-col divide-y divide-dark-200">
        ...
        <div className="flex flex-col p-4">
          ...
          <UserContextSimulator value={userContext} onChange={setUserContext} />
        </div>
