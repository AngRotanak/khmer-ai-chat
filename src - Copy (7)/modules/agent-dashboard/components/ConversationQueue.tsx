...
export function ConversationQueue({ conversations, onSelect }: ConversationQueueProps) {
  ...
  return (
    <div className="w-64 border-r border-dark-600 bg-dark-800 overflow-y-auto">

      {/* Page selector header */}
      <div className="p-2 border-b border-dark-500 bg-dark-800">
        <PageSelector />
      </div>
      ...
      <div className="p-2 border-b border-dark-600">
        ...
        {/* ✅ Animated shortcut hint badge */}
        <div
          className={`mt-1 text-xs text-light-400 flex space-x-3 transform transition-all duration-300 ease-in-out ${showHint ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"
            }`}
        >
          {/* <span className="px-1 py-0.5 rounded bg-dark-600">/</span>
          <span>focus search</span>
          <span className="px-1 py-0.5 rounded bg-dark-600">Esc</span>
