...
export default function TextMessageNodePropertyPanel({
  ...
  return (
    <div className="flex flex-col gap-4.5 p-4 text-light-100 dark:text-light-100">
      {/* Unique Identifier */}
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-2 flex">
          <textarea
            ...
            className="min-h-30 w-full resize-none border border-dark-200 dark:border-dark-600 rounded-md bg-dark-400 dark:bg-dark-800 px-2.5 py-2 text-sm font-medium shadow-sm outline-none transition focus:(border-teal-800 dark:border-teal-500 bg-dark-500 dark:bg-dark-700 ring-2 ring-teal-800/50 dark:ring-teal-500/50) hover:bg-dark-300/60 dark:hover:bg-dark-700/60 placeholder:(text-light-900/50 dark:text-light-100/50 font-normal italic) read-only:(text-light-900/80 dark:text-light-100/80)"
          />
        </div>
      </div>
    </div>
